<%-- 
    Document   : gestionarEstudiantes.jsp
    Autor      : camiv
    Descripción: Vista del rol docente para consultar y editar estudiantes asignados.
                 Requiere atributo 'estudiantes' como lista de mapas con datos clave.
--%>
...
<div class="tabla-box">
    ...
    <%-- 🔙 Botón de regreso al panel docente --%>
